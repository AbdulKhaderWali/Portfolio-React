...
function Navbar({ setDarkMode, darkMode }) {
  return (
    <nav className="sticky top-0 z-30 w-[100%] py-6 mb-20 flex justify-between items-center bg-[#F0EEED] dark:bg-slate-900">
      ...
      <h1 className="text-2xl font-mr font-dafoe dark:text-white">
        Abdul Khader
      </h1>
      <ul className="flex items-center">
        ...
        <li className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-2 py-1 rounded-md ml-3 md:ml-6 lg:ml-10">
          Resume
        </li>
      </ul>
